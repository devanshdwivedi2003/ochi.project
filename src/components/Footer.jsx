...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-900 font-gilroy p-20">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-3">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-3">
            Opening
          </h1>
         <div className="top-[70vh]">
         <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] font-semibold uppercase leading-none -mb-3">
          Presentations
        </h1>
        <div className="dets font-gilroy flex  text-2xl flex-col font-light  gap-2 mt-10  ">
        ...
        <div className="dets font-gilroy flex  text-2xl flex-col font-light  gap-3 mt-10  ">
